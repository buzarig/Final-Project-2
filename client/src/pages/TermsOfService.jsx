...
import "../styles/_termsOfService.scss";

function TermsOfService() {
  return (
    <div className="terms-and-service">
      <div className="terms-and-service__container">
        <div className="terms">
          <h1>Terms of Service</h1>
          <p>
            Welcome to the Shoppe's Terms of Service page. Here, you'll find
            information about the terms and conditions that govern your use of
        ...
        <div className="policy">
          ...
          <p>
            ...
            our Terms of Service. Please carefully read and understand the
            following terms:
          </p>
        </div>
        ...
        <div className="contact">
          <p>
            ...
            our Terms of Service, please don't hesitate to contact us. We're
